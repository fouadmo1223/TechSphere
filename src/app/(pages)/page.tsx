...
export default function Home() {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between min-h-[calc(100vh-82px)] px-6 py-12 md:py-0 " style={{ background: "#efefef" }}>
        <motion.div
        ...
        >
          ...
          <p className="text-xl text-gray-600">
            Discover amazing content and services tailored just for you. Our platform offers the best solutions for your needs.
          </p>
          <motion.button
      ...
      <section className="py-20 bg-gray-50">
        ...
        >
          ...
          <motion.div initial={{ x: -100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <motion.div
                ...
                className={`p-8 rounded-xl shadow-lg bg-white cursor-pointer transition-all ${selectedPlan === index ? "border-2 border-blue-600" : "border-2 border-transparent"
                  }`}
              >
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
             ...
             <StatsComponnent key={ stat.label + index} stat={stat} index={index}/>
            ))}
          </div>
        </motion.div>
      </section>
